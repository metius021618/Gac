...
class Application
{
    ...
    private function loadRoutes(Router $router): void
    {
        ...
        $router->post('/admin/settings/role-create', 'SettingsController@createRole', ['auth']);
        $router->get('/admin/role-preview', 'SettingsController@rolePreview');
        ...
        $router->post('/admin/email-subjects/special-access/bulk', 'EmailSubjectController@specialAccessBulk', ['auth']);
