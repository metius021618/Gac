-- ============================================
-- GAC - Seed de Usuario Administrador (LOCAL)
-- ============================================
...
INSERT IGNORE INTO users (username, email, password, role_id, active) VALUES
('admin', 'admin@gac.local', '$2y$10$zbhZnDqoS7OKq0vnhD1CTu7KvXR/.9BLCWt5xyVDAfqdF2tzWTlWO', 1, 1);
