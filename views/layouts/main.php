...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="/assets/imagenes/letrapoco.png">
    <link rel="apple-touch-icon" href="/assets/imagenes/letrapoco.png">
        ...
        <div class="container">
            <div class="header-content">
                <div class="logo-container">
                    <img src="/assets/imagenes/letrapoco.png" alt="<?= gac_name() ?>" class="logo">
                </div>
