...
<div class="admin-container">
    ...
    <div class="admin-content">
        ...
        <div class="special-access-panel is-hidden" id="specialAccessPanel" aria-hidden="true">
            <div class="special-access-header">
                <div>
                    <h3 class="special-access-title">Usuarios que pueden ver el contenido del asunto seleccionado</h3>
                    <p class="special-access-desc" id="specialAccessSelectedLabel">Selecciona un asunto con el ícono de usuarios.</p>
                </div>
                <button type="button" class="btn btn-secondary btn-sm" id="specialAccessClose">Cerrar</button>
            </div>
            <div class="special-access-toolbar">
                ...
                <div class="special-access-bulk">
                    <button type="button" class="btn btn-secondary btn-sm" id="specialAccessMarkAll">Marcar todo</button>
                    <button type="button" class="btn btn-secondary btn-sm" id="specialAccessUnmarkAll">Desmarcar todo</button>
                </div>
            </div>
            <div id="specialAccessList" class="special-access-list">
                <p class="empty-message">Selecciona un asunto…</p>
            </div>
        </div>
    </div>
</div>
