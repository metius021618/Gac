#!/usr/bin/env python3
"""
GAC - Script Simple de Prueba de Conexión IMAP
Versión simplificada que funciona desde cualquier directorio
"""
...
def test_imap_simple(account_id=None):
    """Probar conexión IMAP de forma simple"""
    print("=" * 60)
    print("GAC - Test de Conexión IMAP (Simple)")
    print("=" * 60 + "\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--account-id', type=int, help='ID de cuenta específica')
    args = parser.parse_args()
    
    success = test_imap_simple(args.account_id)
