...
CRON_CONFIG = {
    ...
    # Intervalo en segundos de espera entre ciclo y ciclo (sync_loop.py). Tras ejecutar ~6s, espera esto. Mínimo 2.
    'reader_loop_seconds': max(2, int(os.getenv('CRON_READER_LOOP_SECONDS', 2))),
